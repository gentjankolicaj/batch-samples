...
public class BatchConfig {
    ...
    public Job getJob(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory,
        ...
        //By default step i run in single thread
    ...
    /**
     * Commented because CustomItemWriter is implemented already
     * @param dataSource
     * @return
     *
     @Bean
     @StepScope public JdbcBatchItemWriter<User> writer(DataSource dataSource){
     return new JdbcBatchItemWriterBuilder<User>()
     .dataSource(dataSource)
     .sql("INSERT INTO USER (id,name,dept) VALUES (:id,:name,dept)")
     .beanMapped()
     .build();
     }
